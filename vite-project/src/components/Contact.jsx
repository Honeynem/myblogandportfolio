    ...
    <div className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action="" className='w-full flex flex-col md:w-1/2'>
                ...
                <input type="text" name='email' placeholder='Enter Your Email' className='p-2 bg-transparent text-white border-2 rounded-md focus:outline-none' />
                <textarea name="message" rows="10" className='p-2 bg-transparent text-white border-2 rounded-md focus:outline-none'></textarea>
