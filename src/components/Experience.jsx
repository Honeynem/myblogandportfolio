        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 px-12 py-8 text-center sm:px-0'>
            {
                techs.map(({id, src, title, style})=> (
                    <div key={id} className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg bg-white ${style}`}>
        ...
        <div className="mt-12">
                    ...
                    <div className="mt-8 grid gap-8">
                        {works.map(({ id, title, company, duration, description, link }) => (
                            <div key={id} className="shadow-lg shadow-gray-600 rounded-lg bg-[#DFF5E3] p-6 transform transition-transform duration-500 hover:scale-105 z-10 bg-white">
